...
public interface StructureDAO extends Disposable
{
	 ...
	 * @return the paging results of molecules
	 */
	 ...
	 * @param structureKey the material criteria
	...
	Collection<Molecule> findMoleculesBySMILE(String smile);


	void saveMolecule(Molecule molecule);


	int deleteMoleculesBySMILE(String canonicalSMILES);
}
