...
<head>
      ...
      <link type="text/css" rel="stylesheet" href="/asap-merck/common/css/site.css"/>    
       ...
       var aldasMerckRender = new ALDaSMerckView(theAJAX,"/asap-merck/","<c:out value="${param.schemeCacheId}"/>","","<c:out value="${param.nodeId}"/>");
       
       var mmRender = new MaterialMgmtView("/asap-merck/","<c:out value="${pageContext.session.id}"/>",theAJAX,web,aldasMerckRender.constructResultsMenuHTML);
