...
function showCalendarById(dateFieldId)
{
   var formElement = document.getElementById(dateFieldId);
   
   showCalendar(formElement);
}//---------------------------------------------------
...
function showCalendar(dateField) {
    ...
    //top.newWin=window.open('${contextPath}/views/common/calendar/calendar.html','cal','dependent=yes,width=210,height=230,screenX=200,screenY=300,titlebar=yes')
